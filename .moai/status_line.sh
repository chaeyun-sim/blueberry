...
if [ -f "/Users/chaeyunsim/go/bin/moai" ]; then
	exec "/Users/chaeyunsim/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/chaeyunsim/.local/bin/moai" ]; then
	exec "/Users/chaeyunsim/.local/bin/moai" statusline < "$temp_file"
fi

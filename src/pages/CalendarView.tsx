...
export default function CalendarView() {
  ...
  return (
    <AppLayout>
      <PageHeader
        title='캘린더'
        description='마감일 기준으로 의뢰를 한눈에 확인하세요'
      />
            ...
            {cells.map((cell, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={cn(
                    'h-auto pb-5 md:pb-1.5 md:min-h-[150px] px-1.5 pt-1.5 border-b border-r border-border/50 transition-colors',
                ...
                >
                  <span
                    className={cn(
                      ...
                      isToday(cell.day) &&
                        cell.currentMonth &&
                        'bg-foreground text-background font-bold ring-2 ring-foreground/20 ring-offset-2 ring-offset-background',
                    )}
                  >
                    {cell.day}
                  </span>
